...
class Solution:
    # recursive approach
    def recursive_0_1_knapsack(self, weights: list, values: list, max_weight: int, n: int):
    ...
    def memoization_0_1_knapsack(self, weights: list, values: list, max_weight: int, n: int, dp):
        if n == 0 or max_weight == 0:
            return 0
        ...
        if weights[n - 1] <= max_weight:
            take = values[n - 1] + self.memoization_0_1_knapsack(weights, values, max_weight - weights[n - 1], n - 1,
                                                                 dp)
    ...
    def tabular_0_1_knapsack(self, weights: list, values: list, max_weight: int, n: int):
